      ...
      >
        <defs>
          <linearGradient id="lineGradient" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <stop offset="50%" stopColor="hsl(var(--border))" stopOpacity="0.3" />
        ...
        <g className="animate-float-slow">
          <line x1="0" y1="100" x2="1200" y2="120" stroke="url(#lineGradient)" strokeWidth="1">
            <animate attributeName="x2" values="1200;800;1200" dur="15s" repeatCount="indefinite" />
          </line>
          <line x1="0" y1="250" x2="1200" y2="270" stroke="url(#lineGradient)" strokeWidth="1">
            <animate attributeName="x2" values="1200;600;1200" dur="20s" repeatCount="indefinite" />
          </line>
          <line x1="0" y1="450" x2="1200" y2="470" stroke="url(#lineGradient)" strokeWidth="1">
            <animate attributeName="x2" values="1200;900;1200" dur="18s" repeatCount="indefinite" />
          </line>
          <line x1="0" y1="650" x2="1200" y2="670" stroke="url(#lineGradient)" strokeWidth="1">
        ...
        <g className="animate-float-reverse">
          <line x1="0" y1="0" x2="400" y2="800" stroke="hsl(var(--border))" strokeWidth="1" opacity="0.2">
          ...
          <line x1="600" y1="0" x2="1000" y2="800" stroke="hsl(var(--border))" strokeWidth="1" opacity="0.2">
        ...
        <g className="animate-pulse-slow">
          <circle cx="200" cy="150" r="2" fill="url(#dotGradient)">
          ...
          <circle cx="800" cy="300" r="2" fill="url(#dotGradient)">
            <animate attributeName="r" values="2;3;2" dur="10s" repeatCount="indefinite" />
            <animate attributeName="cx" values="800;600;800" dur="15s" repeatCount="indefinite" />
          </circle>
          <circle cx="500" cy="500" r="2" fill="url(#dotGradient)">
            <animate attributeName="r" values="2;5;2" dur="12s" repeatCount="indefinite" />
            <animate attributeName="cy" values="500;300;500" dur="18s" repeatCount="indefinite" />
          </circle>
          <circle cx="1000" cy="200" r="2" fill="url(#dotGradient)">
